...
The idea was to find a set of diverse techniques with different levels of complexity.

\todo{Explain the criteria and present a table.}
%One-handed i.e. they are to be performed with only one hand
...
\begin{figure}[H]
\subfloat[]{\includegraphics[width = 1\columnwidth]{images/SwipeDetailed2.jpg}\label{fig:swipeTechnique1}}
\caption{
...
\begin{figure}[H]
\subfloat[]{\includegraphics[width = 1\columnwidth]{images/TiltDetailed.jpg}\label{fig:tiltTechnique1}}
\caption{
...
\begin{figure}[H]
\subfloat[]{\includegraphics[width = 1\columnwidth]{images/Throw1.jpg}\label{fig:throwTechnique1}}
\caption{
