...
Focusing on the collaborative and cross-device side, Lucero et. al. created MobiComics with the purpose to \emph{``explore shared collocated interaction with mobile phones and public displays in indoor public place.''} \cite{Lucero:2012}. They discovered that most of their participants (36) were positive about using their personal devices to create a common interaction space, but some of them would only share their devices with people they knew. Additionally they found that half of their participants raised concerns for privacy in regards to taking pictures of strangers in the public space and 10 were also concerned about people being able to keep \emph{MobiComics} after the session.
