...
%When we look at todays solutions we see technoligy where the products acts to aid the users in the every day. It is easy to syncronize devices and schedules. An update on facebook could for instance be added to the users schedule when signing up for an event.
