...
The yellow highlighted cell is the cell in which the pointer is currently located inside of. 
This is extra feedback for the user so that he knows exactly were he will hit once we performs the technique.
