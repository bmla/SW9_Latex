...
\begin{table}[]
	...
	\begin{tabular}{|
		...
		ThL & \textbf{0.001}             & \textbf{0.001}                & 0.091                                  & \cellcolor[HTML]{CBCEFB}0.240          & \cellcolor[HTML]{FFFFFF}               & 0.354                                  & \textbf{0.001}                         & \textbf{0.001}              \\ \hline
		ThS & \textbf{0.001}             & \textbf{0.001}                & \textbf{0.006}                         & \cellcolor[HTML]{CBCEFB}\textbf{0.020} & \cellcolor[HTML]{CBCEFB}0.181          & \cellcolor[HTML]{FFFFFF}               & \textbf{0.001}                         & \textbf{0.001}              \\ \hline
		TiL & \textbf{0.014}             & \textbf{0.001}                & \textbf{0.001}                         & \cellcolor[HTML]{CBCEFB}\textbf{0.001} & \cellcolor[HTML]{CBCEFB}\textbf{0.001} & \cellcolor[HTML]{CBCEFB}\textbf{0.001} & \cellcolor[HTML]{FFFFFF}               & 0.608                       \\ \hline
		TiS & 0.773                      & 0.592                         & \textbf{0.001}                         & \cellcolor[HTML]{CBCEFB}\textbf{0.001} & \cellcolor[HTML]{CBCEFB}\textbf{0.001} & \cellcolor[HTML]{CBCEFB}\textbf{0.001} & \cellcolor[HTML]{CBCEFB}\textbf{0.003} & \cellcolor[HTML]{FFFFFF}    \\ \hline
	\end{tabular}
	\end{adjustbox}
\end{table}
...
\begin{table}[]
	...
	\begin{tabular}{|
		...
		ThS & \textbf{}                  & \textbf{}                     & \textbf{}                              & \textbf{}                              & \cellcolor[HTML]{FFFFFF}               & \cellcolor[HTML]{FFFFFF}          & \textbf{0.001}                    & \textbf{0.001}              \\ \hline
		TiL & \textbf{}                  & \textbf{}                     & \textbf{}                              & \textbf{}                              & \cellcolor[HTML]{FFFFFF}\textbf{}      & \cellcolor[HTML]{FFFFFF}\textbf{} & \cellcolor[HTML]{FFFFFF}          & 0.120                       \\ \hline
		TiS &                            &                               & \textbf{}                              & \textbf{}                              & \cellcolor[HTML]{FFFFFF}\textbf{}      & \cellcolor[HTML]{FFFFFF}\textbf{} & \cellcolor[HTML]{FFFFFF}\textbf{} & \cellcolor[HTML]{FFFFFF}    \\ \hline
	\end{tabular}
	\end{adjustbox}
\end{table}
