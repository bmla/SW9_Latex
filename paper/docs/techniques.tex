...
We are also interested in examining the effect of each technique on targets of different sizes. Therefore, we will implement targets of two different sizes, large and small, relative to the size of the screen. 
...
\todo{Insert following paragraph later}
