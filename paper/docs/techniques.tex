...
We chose four techniques named \swipe, \tilt, \throw, and \pinch because they all fulfill different aspects of the criteria requirements in \Cref{tab:techniqueCriteria} and this allows us to compare them to each other.
