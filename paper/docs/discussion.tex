...
When looking at the results on the effect of the four techniques, \pinch, \swipe, \throw and \tilt, as well as the two grid sizes, small and large, on the time per target, the results tell a rather interesting story. 
...
The figures show that \swipe and \throw have a large concentration of hits inside the target cell, where \pinch and \tilt have quite a spread of hits outside the target cell. 
...
\begin{figure}[H]
	...
	\caption{
		...
		\protect\subref{fig:smallpinchHB} Pinch (Small Grid)
		\protect\subref{fig:smallswipeHB} Swipe (Small Grid)
		\protect\subref{fig:smallthrowHB} Throw (Small Grid)
		\protect\subref{fig:smalltiltHB} Tilt (Small Grid)
		\protect\subref{fig:largepinchHB} Pinch (Large Grid)
		\protect\subref{fig:largeswipeHB} Swipe (Large Grid)
		\protect\subref{fig:largethrowHB} Throw (Large Grid)
		\protect\subref{fig:largetiltHB} Tilt (Large Grid)
	}
	\label{fig:thitboxes}
\end{figure}
