...
\begin{figure}[H]
	...
	\qquad
	\subfloat[]{\includegraphics[height = 2cm ]{images/phoneScreenshot.png}\label{fig:phoneScreen}}
	\caption{
		\protect\subref{fig:kinectScreen} The large display screen of the application.
...
The application chose at random one of the four techniques and display a short explanatory movie of how to perform the technique on a screen right beside the main application display(See \Cref{fig:tutVideo}).
