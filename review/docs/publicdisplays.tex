...
\todo[inline]{We see a difference between large display and public display that almost every paper about public display includes the context of getting the users attention. This is often done by creating content that attracts pople and tries to achieve a honeypot effect. A second challenge that is often described in papers about public display is the need to create immersion and focus on the content, as well as  working with the challenge of playfullness - to make the user do more than just play with the system.}
...
They \emph{``discuss how to design for and evaluate engagement in a public walk-up-and-use installation''} \cite{Jacucci:2010}. %  rephase. Why do they want to descuss it, what do they suggest?
