...
\begin{figure}[H]
	\centering
	\subfloat[]{\includegraphics[width = 0.7\columnwidth]{images/SetupIllustration.jpg}}
	\caption{
...
These will henceforth be referred to as large grid ($5 \times 10$) and small grid ($10 \times 20$). This can be seen in \Cref{fig:kinectScreen}. \todo{Add sizes}
...
\begin{figure}[H]
	\centering
	\subfloat[]{\includegraphics[width = 0.7\columnwidth]{images/setup.jpg}}
	\caption{
